            ...
            o.querySelectorAll(
                ...
                t.addEventListener("click", function (t) {
                    ...
                    $(document).on("click", ".btn-delete", function() {
                        ...
                        Swal.fire({
                            text: "Are you sure you want to delete Question " + role_name + "?",
                            icon: "warning",
                            showCancelButton: !0,
                            buttonsStyling: !1,
                            ...
                            {
                                var delete_list = {
                                    "url": url_Base+"question/delete/"+role_id,
                                    "method": "POST",
                                    "headers": {
                                ...
                                $.ajax(delete_list).done(function (response) 
                                {
                                    ...
                                    {
                                        Swal.fire({
                                            text: "You have deleted Question " + role_name + "!.",
                                            icon: "success",
                                            buttonsStyling: !1,
                                    ...
                                    {
                                        Swal.fire({
                                            text: "Question "+ role_name + " was not deleted.",
                                            icon: "error",
                                            buttonsStyling: !1,
                                            confirmButtonText: "Ok, got it!",
                                            customClass: {
            ...
            s.addEventListener("click", function () {
                ...
                Swal.fire({
                    ...
                    if (array.length) {
                        ...
                        var delete_list = {
                            "method": "POST",
                            "url": url_Base+"question/delete_array",
                            "data":formData,
                            "dataType": "json",
                            "encode": true,
                            "headers": {
                        ...
                        $.ajax(delete_list).done(function (response) 
                        {
                            ...
                            {
                                Swal.fire({
                                    text: "You have deleted Question !.",
                                    icon: "success",
                                    buttonsStyling: !1,
                                    confirmButtonText: "Ok, got it!",
                                    customClass: {
