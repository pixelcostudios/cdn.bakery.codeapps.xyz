                        ...
                        Swal.fire({
                            ...
                            if(t.value==true)
                            {
                                ...
                                $.ajax(delete_list).done(function (response) 
                                {
                                    if(response.status==200)
                                    {
                                        ...
                                        .then(function () {
                                            ...
                                            $(o).DataTable({
                                                info: !1,
                                                order: [],
                                                ajax: url_Base+"testimonial_json",
                                                pageLength: 10,
                                                lengthChange: !1,
                                                columnDefs: [
                                    ...
                                    {
                                        Swal.fire({
                                            text: "Testimonial "+ role_name + " was not deleted.",
                                            icon: "error",
                                            buttonsStyling: !1,
                                            confirmButtonText: "Ok, got it!",
                                            customClass: {
                ...
                Swal.fire({
                    ...
                    if (array.length) {
                        ...
                        $.ajax(delete_list).done(function (response) 
                        {
                            ...
                            {
                                Swal.fire({
                                    text: "Testimonial was not deleted.",
                                    icon: "error",
                                    buttonsStyling: !1,
                                    confirmButtonText: "Ok, got it!",
                                    customClass: {
                ...
                (() => {
                    ...
                    n.addEventListener("click", function () {
                        ...
                        $(o).DataTable({
                            info: !1,
                            order: [],
                            ajax: url_Base+"testimonial_json?cat_id="+cat_id+"&status="+status,
                            pageLength: 10,
                            lengthChange: !1,
                            columnDefs: [
                                { orderable: !1, targets: 0 },
