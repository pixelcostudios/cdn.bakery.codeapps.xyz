    ...
    var e,
            ...
            o.querySelectorAll(
                ...
                t.addEventListener("click", function (t) {
                    ...
                    $(document).on("click", ".btn-delete", function() {
                        ...
                        Swal.fire({
                            text: "Are you sure you want to delete Product Unit " + role_name + "?",
                            icon: "warning",
                            showCancelButton: !0,
                            buttonsStyling: !1,
                            ...
                            {
                                var delete_list = {
                                    "url": url_Base+"product/unit_p_delete/"+role_id,
                                    "method": "POST",
                                    "headers": {
                                ...
                                $.ajax(delete_list).done(function (response) 
                                {
                                    ...
                                    {
                                        Swal.fire({
                                            text: "You have deleted Product Unit " + role_name + "!.",
                                            icon: "success",
                                            buttonsStyling: !1,
                                        ...
                                        .then(function () {
                                            ...
                                            $(o).DataTable({
                                                info: !1,
                                                order: [],
                                                ajax: url_Base+"product/unit_json",
                                                pageLength: 10,
                                                lengthChange: !1,
                                                columnDefs: [
                                    ...
                                    {
                                        Swal.fire({
                                            text: "Product Unit "+ role_name + " was not deleted.",
                                            icon: "error",
                                            buttonsStyling: !1,
                                            confirmButtonText: "Ok, got it!",
                                            customClass: {
        ...
        l = () => {
            ...
            s.addEventListener("click", function () {
                ...
                Swal.fire({
                    text: "Are you sure you want to delete selected Product Unit?",
                    icon: "warning",
                    showCancelButton: !0,
                    buttonsStyling: !1,
                    confirmButtonText: "Yes, delete!",
                    ...
                    if (array.length) {
                        ...
                        var delete_list = {
                            "method": "POST",
                            "url": url_Base+"product/unit_delete_array",
                            "data":formData,
                            "dataType": "json",
                            "encode": true,
                            "headers": {
                        ...
                        $.ajax(delete_list).done(function (response) 
                        {
                            ...
                            {
                                Swal.fire({
                                    text: "You have deleted Product Unit !.",
                                    icon: "success",
                                    buttonsStyling: !1,
                                    confirmButtonText: "Ok, got it!",
                                    customClass: {
                            ...
                            {
                                Swal.fire({
                                    text: "Product Unit was not deleted.",
                                    icon: "error",
                                    buttonsStyling: !1,
                                    confirmButtonText: "Ok, got it!",
                                    customClass: {
                    ...
                    {
                        Swal.fire({
                            text: "Product Unit was not deleted s.",
                            icon: "error",
                            buttonsStyling: !1,
                            confirmButtonText: "Ok, got it!",
                            customClass: {
