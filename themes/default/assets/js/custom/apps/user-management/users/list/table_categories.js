            ...
            o.querySelectorAll(
                ...
                t.addEventListener("click", function (t) {
                    ...
                    $(document).on("click", ".btn-delete", function() {
                        ...
                        Swal.fire({
                            text: "Are you sure you want to delete Categories " + role_name + "?",
                            icon: "warning",
                            showCancelButton: !0,
                            buttonsStyling: !1,
                            ...
                            {
                                var delete_list = {
                                    "url": url_Base+"categories/delete/"+role_id,
                                    "method": "POST",
                                    "headers": {
                                ...
                                $.ajax(delete_list).done(function (response) 
                                {
                                    ...
                                    {
                                        Swal.fire({
                                            text: "You have deleted Categories " + role_name + "!.",
                                            icon: "success",
                                            buttonsStyling: !1,
                                        ...
                                        .then(function () {
                                            ...
                                            $(o).DataTable({
                                                info: !1,
                                                order: [],
                                                ajax: url_Base+"categories_json?cat_type="+cat_type,
                                                pageLength: 10,
                                                lengthChange: !1,
                                                columnDefs: [
                                    ...
                                    {
                                        Swal.fire({
                                            text: "Categories "+ role_name + " was not deleted.",
                                            icon: "error",
                                            buttonsStyling: !1,
                                            confirmButtonText: "Ok, got it!",
                                            customClass: {
        ...
        l = () => {
            ...
            s.addEventListener("click", function () {
                ...
                Swal.fire({
                    ...
                    let array = $("input:checkbox[name=cat_id]:checked")
                        .map(function (){
                        return $(this).val();
                    }).toArray();
                    ...
                    if (array.length) {
                        ...
                        var delete_list = {
                            "method": "POST",
                            "url": url_Base+"categories/delete_array",
                            "data":formData,
                            "dataType": "json",
                            "encode": true,
                            "headers": {
                        ...
                        $.ajax(delete_list).done(function (response) 
                        {
                            ...
                            {
                                Swal.fire({
                                    text: "You have deleted Categories !.",
                                    icon: "success",
                                    buttonsStyling: !1,
                                    confirmButtonText: "Ok, got it!",
                                    customClass: {
                            ...
                            {
                                Swal.fire({
                                    text: "Categories was not deleted.",
                                    icon: "error",
                                    buttonsStyling: !1,
                                    confirmButtonText: "Ok, got it!",
                                    customClass: {
