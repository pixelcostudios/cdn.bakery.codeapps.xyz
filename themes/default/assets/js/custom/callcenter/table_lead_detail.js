                ...
                t.addEventListener("click", function (t) {
                    ...
                    $(document).on("click", ".btn-delete", function() {
                        ...
                        Swal.fire({
                            ...
                            {
                                var delete_list = {
                                    "url": url_Base+"outbound/lead_detail_p_delete/"+role_id,
                                    "method": "POST",
                                    "headers": {
                                    ...
                                    if(response.status==200)
                                    {
                                        ...
                                        .then(function () {
                                            ...
                                            $(o).DataTable({
                                                info: !1,
                                                order: [],
                                                ajax: url_Base+"outbound/lead_detail_json?lead_id="+lead_id,
                                                pageLength: 10,
                                                lengthChange: !1,
                                                columnDefs: [
            ...
            s.addEventListener("click", function () {
                ...
                Swal.fire({
                    ...
                    if (array.length) {
                        ...
                        var delete_list = {
                            "method": "POST",
                            "url": url_Base+"outbound/lead_detail_delete_array",
                            "data":formData,
                            "dataType": "json",
                            "encode": true,
                            "headers": {
