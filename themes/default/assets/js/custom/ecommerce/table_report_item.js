                ...
                t.addEventListener("click", function (t) {
                    ...
                    $(document).on("click", ".btn-delete", function() {
                        ...
                        Swal.fire({
                            ...
                            {
                                var delete_list = {
                                    "url": url_Base+"item_p_delete/"+role_id,
                                    "method": "POST",
                                    "headers": {
                                    ...
                                    if(response.status==200)
                                    {
                                        ...
                                        .then(function () {
                                            ...
                                            $(o).DataTable({
                                                info: !1,
                                                order: [],
                                                ajax: url_Base+"report/item_json",
                                                pageLength: 10,
                                                lengthChange: !1,
                                                columnDefs: [
            ...
            s.addEventListener("click", function () {
                ...
                Swal.fire({
                    ...
                    if (array.length) {
                        ...
                        var delete_list = {
                            "method": "POST",
                            "url": url_Base+"item_delete_array",
                            "data":formData,
                            "dataType": "json",
                            "encode": true,
                            "headers": {
                ...
                (e = $(o).DataTable({
                    ...
                    var tueTotal = api
                     ...
                     var friTotal = api
                        ...
                        $( api.column( 5 ).footer() ).html(rupiah(friTotal));
                    },
                ...
                (() => {
                    ...
                    n.addEventListener("click", function () {
                        ...
                        $(o).DataTable({
                            info: !1,
                            order: [],
                            ajax: url_Base+"report/item_json?start_date="+start_date+"&end_date="+end_date,
                            pageLength: 10,
                            lengthChange: !1,
                            columnDefs: [
                                { orderable: !1, targets: 0 },
                            ...
                            // footerCallback: function(tfoot, ajax, start, end, display) {
                            //     var api = this.api();
                        ...
                        console.log(url_Base+"report/item_json?start_date="+start_date+"&end_date="+end_date);
                        // var t = "";
                        // r.forEach((e, n) => {
                        //     e.value &&
                        //         "" !== e.value &&
