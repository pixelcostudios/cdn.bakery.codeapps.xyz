                ...
                t.addEventListener("click", function (t) {
                    ...
                    $(document).on("click", ".btn-delete", function() {
                        ...
                        Swal.fire({
                            ...
                            {
                                var delete_list = {
                                    "url": url_Base+"product/transaction_delete/"+role_id,
                                    "method": "POST",
                                    "headers": {
                                    ...
                                    if(response.status==200)
                                    {
                                        ...
                                        .then(function () {
                                            ...
                                            $(o).DataTable({
                                                info: !1,
                                                order: [],
                                                ajax: url_Base+"product/transaction_json",
                                                pageLength: 10,
                                                lengthChange: !1,
                                                columnDefs: [
            ...
            s.addEventListener("click", function () {
                ...
                Swal.fire({
                    ...
                    if (array.length) {
                        ...
                        var delete_list = {
                            "method": "POST",
                            "url": url_Base+"product/transaction_delete_array",
                            "data":formData,
                            "dataType": "json",
                            "encode": true,
                            "headers": {
                            ...
                            if(response.status==200)
                            {
                                ...
                                .then(function () {
                                    ...
                                    $(o).DataTable({
                                        info: !1,
                                        order: [],
                                        ajax: url_Base+"product/transaction_json?start_date="+start_date+"&end_date="+end_date,
                                        pageLength: 10,
                                        lengthChange: !1,
                                        columnDefs: [
                                            { orderable: !1, targets: 0 },
                                    ...
                                    console.log(url_Base+"product/transaction_json?start_date="+start_date+"&end_date="+end_date);
                                })
                                .then(function () {
                                    a();
                                });
            ...
            o &&
                ...
                (e = $(o).DataTable({
                    ...
                    var total_price = api
                        ...
                        // $(row).find('th').eq(4).html( "Hello Word");
                        ...
                        $( api.column( 6 ).footer() ).html(rupiah(total_price));
                    },
                })).on("draw", function () {
                    l(), c(), a();
                }),
