...
var KTAuthResetPassword = function () {
    ...
    return {
        init: function () {
            t = document.querySelector("#kt_resend_form"), e = document.querySelector("#kt_resend_submit"), r = FormValidation.formValidation(t, {
                fields: {
                    email: {
                        validators: {
                            regexp: {
                ...
                i.preventDefault(), r.validate().then((function (r) {
                    ...
                    axios.post(e.closest("form").getAttribute("action"), new FormData(t)).then((function (e) {
                        if (e) {
                            t.reset(), Swal.fire({
                                text: "We have send a reset link verify to your email.",
                                icon: "success",
                                buttonsStyling: !1,
                                confirmButtonText: "Ok, got it!",
                                customClass: {
